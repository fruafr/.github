# Index of Public Repositories published by fruafr
...
- [rust-jfsm](https://github.com/fruafr/rust-jfsm): A command-line tool to read file system metadata then return it in JSON format. Output and Error messages in JSON format.
